...
import java.util.Scanner; // programa utiliza a classe
...
public class ClassAverage {
    public static void main(String[] args) {
        ...
        while (grade != -1) {
            ...
            gradeCounter = gradeCounter + 1; // incrementa coutner

            // solicita entrada e lê a próxima nota forneceida pelo usuário
            System.out.print("Enter grade or -1 to quit: ");
            grade = input.nextInt();
        }
